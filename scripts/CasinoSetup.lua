require("init")
local CrVO=Global.CreateVehicle			--v1.60 Create Vehicle offset
...
local CsSet=menu.add_submenu("Casino Setup 1.60 - works to?")
...
menu.add_bare_item(" reset menu? i guess", function() APRSP:clear() GUN:clear() CAR:clear() CsCT:clear() CurAp() WEAPON() DRIVER() CUT() end, null, null, null) --174 254