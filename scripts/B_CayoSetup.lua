...
local cayoset_menu=menu.add_submenu("Cayo Setup 1.60")
...
cayoset_menu:add_bare_item("  GoodThingsMightCome2ThoseWhoWait", function() cayocut_menu:clear() CUT() end, null, null, null)